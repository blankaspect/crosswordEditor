...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
                           ...
                           int               width )
        {
            ...
            // Set clues
            if ( !ListUtilities.isNullOrEmpty( clues ) )
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CrosswordPanel( CrosswordDocument document )
        {
            ...
            // Set border
            GuiUtilities.setPaddedLineBorder( this, 8 );
            ...
            int width = GuiUtilities.getCharWidth( '0',
                                                   selectedCluePanel.
                                                        getFontMetrics( selectedCluePanel.getFont( ) ) );
            width *= AppConfig.getInstance( ).getSelectedClueNumColumns( );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CluePanel createCluePanel( Direction direction )
        {
            ...
            List<Clue> clues = new ArrayList<>( );
            List<Clue> definedClues = document.getClues( direction );
            ...
            for ( Grid.Field field : fields )
            {
                ...
                int index = Collections.binarySearch( definedClues, clue, Clue.FieldIdComparator.instance );
                if ( index < 0 )
                    clues.add( clue );
                else
                {
                    while ( index < definedClues.size( ) )
                    {
                        clue = definedClues.get( index );
        ...
        private JLabel createTitleLabel( )
        {
            ...
            boolean isTitle = !StringUtilities.isNullOrEmpty( title );
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return AppConfig.getInstance( ).getViewColour( key );
    }
