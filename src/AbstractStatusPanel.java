...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static final    String  PROTOTYPE_STR   = StringUtilities.createCharString( ' ', 4 );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected void paintComponent( Graphics gr )
        {
            ...
            if ( text != null )
            {
                ...
                String str = TextUtilities.getLimitedWidthString( text, fontMetrics, maxWidth,
                                                                  TextUtilities.RemovalMode.END );
                gr.setColor( AppConfig.getInstance( ).getStatusTextColour( ) );
