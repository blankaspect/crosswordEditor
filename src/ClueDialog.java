...
////////////////////////////////////////////////////////////////////////
                        ...
                        Clue              clue )
    {
        ...
        boolean allowMultipleFieldUse = AppConfig.getInstance( ).isAllowMultipleFieldUse( );
        ...
        for ( Direction direction : Direction.DEFINED_DIRECTIONS )
        {
            ...
            for ( Grid.Field field : document.getGrid( ).getFields( direction ) )
            {
                ...
                int index = Collections.binarySearch( clues, new Clue( fieldId ),
                                                      Clue.FieldIdComparator.instance );
                if ( index < 0 )
        ...
        {
            int numDigits = NumberUtilities.getNumDigitsDec( field.getNumber( ) );
        ...
        textPanel = new TextPanel( TEXT_AREA_NUM_ROWS, clue.hasText( ) ? clue.getText( ).toString( ) : null,
                                   true );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Clue showDialog( Component         parent,
                                   ...
                                   Clue              clue )
    {
        return new ClueDialog( GuiUtilities.getWindow( parent ), document, clue ).getClue( );
    }
