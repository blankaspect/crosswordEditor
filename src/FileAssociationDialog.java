...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return new FileAssociationDialog( GuiUtilities.getWindow( parent ) ).getResult( );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        if ( actionComboBox.getSelectedValue( ) == Action.ADD )
        {
            ...
            {
                GuiUtilities.setFocus( javaLauncherPathnameField );
                throw e;
            }
            ...
            {
                GuiUtilities.setFocus( jarPathnameField );
                throw e;
            }
            ...
            {
                GuiUtilities.setFocus( iconPathnameField );
                throw e;
            }
        }
    }
