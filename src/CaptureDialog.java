...
import uk.org.blankaspect.gui.MenuButton;
import uk.org.blankaspect.gui.ParameterSetDialog;
...
import uk.org.blankaspect.textfield.IntegerField;

import uk.org.blankaspect.util.ClipboardImage;
...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    float   BRIGHTNESS_THRESHOLD_FACTOR = 0.01f;
    ...
    private static final    String  BASE_FILENAME_STR       = "Base filename:";
    ...
    private static final    String  CONFIRM_CLEAR_STR       = "Do you want to clear the crossword number," +
                                                                "prologue, epilogue,\ngrid image and " +
                                                                "lists of clues?";
...
////////////////////////////////////////////////////////////////////////
                           ...
                           int    documentIndex )
    {
        ...
        // Button: clear
        clearButton = new Button( AppConstants.CLEAR_STR + AppConstants.ELLIPSIS_STR, Command.CLEAR,
                                  KeyEvent.VK_L );
        captureButtonPanel.add( clearButton );

        // Button: get grid image
        getGridImageButton = new Button( GET_GRID_IMAGE_STR + AppConstants.ELLIPSIS_STR,
                                         Command.GET_GRID_IMAGE, KeyEvent.VK_G );
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return new CaptureDialog( GuiUtilities.getWindow( parent ), documentIndex ).getDocument( );
    }
    ...
    public void actionPerformed( ActionEvent event )
    {
        try
        {
            ...
            if ( command.equals( Command.SELECT_GRID_SEPARATOR ) )
                ...
                onGetClues( StringUtilities.removePrefix( command, Command.GET_CLUES ) );
...
////////////////////////////////////////////////////////////////////////
    ...
    private void updateClipboardButtons( )
    {
        ...
        getCluesButton.setEnabled( Util.clipboardHasText( ) );
    }
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( answerLengthPanel.getPatternField( ) );
            int index = e.getIndex( );
            if ( index >= 0 )
                answerLengthPanel.getPatternField( ).setCaretPosition( index );
            throw new AppException( ErrorId.MALFORMED_PATTERN, RegexUtilities.getExceptionMessage( e ) );
        }
    }
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( documentDirectoryField );
            throw e;
        }
        ...
        {
            GuiUtilities.setFocus( htmlDirectoryField );
            throw e;
        }
    }
    ...
    private JPanel createPanelClueSubstitutions( )
    {
        ...
        GuiUtilities.setPaddedLineBorder( clueSubstitutionsPanel, 8 );
    ...
    private JPanel createPanelFile( )
    {
        ...
        // Label: filename
        JLabel filenameLabel = new FLabel( BASE_FILENAME_STR );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( filenameLabel, gbc );
        controlPanel.add( filenameLabel );

        // Field: filename
        filenameField = new FTextField( FILENAME_FIELD_NUM_COLUMNS );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( filenameField, gbc );
        ...
        throws AppException
    {
        ...
        BufferedImage image = Util.getClipboardImage( );
        ...
        if ( autoGridDetectionCheckBox.isSelected( ) )
        {
            try
            {
                float brightnessThreshold = (float)gridLineBrightnessThresholdSpinner.getIntValue( ) *
                ...
                gridInfo = Grid.findGrid( image, brightnessThreshold, minLineLength, minLineSeparation,
                                          endpointTolerance );
                String messageStr = StringUtilities.substitute( GRID_FOUND_STR,
                                                                Integer.toString( gridInfo.numColumns ),
        ...
        Dimension viewportSize = AppConfig.getInstance( ).getGridImageViewportSize( );
        ...
        throws AppException
    {
        ...
        if ( JOptionPane.showOptionDialog( this, CONFIRM_CLEAR_STR, AppConstants.CLEAR_STR,
        ...
        throws AppException
    {
                                             ...
                                             null ) == JOptionPane.OK_OPTION) )
        {
            ...
            parameterSetFileChooser.setSelectedFile( new File( new String( ) ) );
            ...
            {
                file = Util.appendSuffix( parameterSetFileChooser.getSelectedFile( ),
                                          AppConstants.XML_FILE_SUFFIX );
                if ( file.exists( ) && !file.isFile( ) )
                    throw new FileException( ErrorId.NOT_A_FILE, file );
                config.setParameterSetPathname( Util.getPathname( file ) );
            }
        }
        ...
        if ( file != null )
        {
            ...
            CaptureParams params = ParameterSetDialog.showDialog( this,
                                                                  CAPTURE_STR + " | " + PARAMETER_SET_STR,
        ...
        throws AppException
    {
        ...
        switch ( getGridSeparator( ) )
        {
            case BLOCK:
            {
                float brightnessThreshold = (float)blockBrightnessThresholdSpinner.getIntValue( ) *
                                                                                BRIGHTNESS_THRESHOLD_FACTOR;
            ...
            case BAR:
            {
                float brightnessThreshold = (float)barBrightnessThresholdSpinner.getIntValue( ) *
                                                                                BRIGHTNESS_THRESHOLD_FACTOR;
                grid = new BarGrid( numColumns, numRows, gridImage, xOffset, yOffset,
                                    brightnessThreshold, barWidthThreshold );
                break;
            }
        }
        ...
        if ( document.validateClues( AppConstants.CANCEL_STR ) )
        {
            ...
            String lineBreak = AppConfig.getInstance( ).getTextSectionLineBreak( );
            document.setPrologue( prologuePanel.getParagraphs( lineBreak ) );
            document.setEpilogue( epiloguePanel.getParagraphs( lineBreak ) );

            // Set base filename and directories in document
            if ( !filenameField.isEmpty( ) )
                document.setBaseFilename( getText( filenameField ) );
