...
import uk.org.blankaspect.gui.InformationField;
...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    String  IMPLICIT_FIELD_DIRECTION_STR    = "Implicit direction of secondary " +
                                                                        "fields:";
    ...
    private static final    String  EXCESS_BAR_WIDTH_STR                = "Excess bar width:";
    private static final    String  HTML_GRID_COLOUR_STR                = "HTML grid colour";
    private static final    String  BLOCK_IMAGE_COLOUR_STR              = "HTML block-image colour";
...
////////////////////////////////////////////////////////////////////////
    ...
    public void actionPerformed( ActionEvent event )
    {
        ...
        if ( command.startsWith( Command.EDIT_DIRECTION_KEYWORDS ) )
            onEditDirectionKeywords( StringUtilities.removePrefix( command,
...
////////////////////////////////////////////////////////////////////////
    ...
    private void onChooseViewColour( )
    {
        ...
        Color colour = JColorChooser.showDialog( this, VIEW_COLOUR_STR + colourId,
                                                 viewColourButton.getForeground( ) );
        if ( colour != null )
        {
    ...
    {
        Color colour = JColorChooser.showDialog( this, HTML_GRID_COLOUR_STR,
                                                 htmlGridColourButton.getForeground( ) );
        if ( colour != null )
    ...
    {
        Color colour = JColorChooser.showDialog( this, BLOCK_IMAGE_COLOUR_STR,
    ...
    private JPanel createPanelHtml( )
    {
        ...
        htmlViewerCommandField = new FTextField( config.getHtmlViewerCommand( ),
                                                 HTML_VIEWER_COMMAND_FIELD_NUM_COLUMNS );
        ...
        // Field: font names
        htmlFontNamesField = new StringListField( HTML_FONT_NAMES_FIELD_NUM_COLUMNS,
                                                  config.getHtmlFontNames( ) );
        ...
        // Spinner: font size
        htmlFontSizeSpinner = new FIntegerSpinner( config.getHtmlFontSize( ),
                                                   CrosswordDocument.MIN_HTML_FONT_SIZE,
                                                   CrosswordDocument.MAX_HTML_FONT_SIZE,
                                                   HTML_FONT_SIZE_FIELD_LENGTH );
        ...
        fieldNumberFontSizeFactorSpinner =
                            new FDoubleSpinner( config.getHtmlFieldNumberFontSizeFactor( ),
        ...
        // Filler
        Box.Filler filler = GuiUtilities.createFiller( );
        ...
        // Spinner: bar width
        htmlBarWidthSpinner = new FIntegerSpinner( config.getHtmlBarGridBarWidth( ),
                                                   GridPanel.Bar.MIN_BAR_WIDTH, GridPanel.Bar.MAX_BAR_WIDTH,
                                                   BAR_WIDTH_FIELD_LENGTH );
        ...
        // Label: excess bar width
        JLabel excessBarWidthLabel = new FLabel( EXCESS_BAR_WIDTH_STR );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( excessBarWidthLabel, gbc );
        barPanel.add( excessBarWidthLabel );

        // Combo box: excess bar width
        htmlExcessBarWidthComboBox = new FComboBox<>( BarGrid.ExcessBarWidth.values( ) );
        htmlExcessBarWidthComboBox.setSelectedValue( config.getHtmlBarGridExcessBarWidth( ) );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( htmlExcessBarWidthComboBox, gbc );
        barPanel.add( htmlExcessBarWidthComboBox );
    ...
    private void setPreferencesClues( )
    {
        ...
        for ( Direction direction : clueDirectionKeywordsFields.keySet( ) )
        {
            ...
            config.setClueDirectionKeywords( direction,
                                             names.isEmpty( ) ? new StringList( direction.getKeywords( ) )
                                                              : names );
        }
        config.setClueReferenceKeyword( clueReferenceKeywordField.isEmpty( )
                                                                ? null
    ...
    {
        AppConfig config = AppConfig.getInstance( );
        config.setHtmlViewerCommand( htmlViewerCommandField.isEmpty( )
                                                                    ? null
                                                                    : htmlViewerCommandField.getText( ) );
        ...
        config.setHtmlBarGridExcessBarWidth( htmlExcessBarWidthComboBox.getSelectedValue( ) );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private JButton                                 viewColourButton;
    ...
    private JButton                                 htmlGridColourButton;
    ...
    private JButton                                 blockImageColourButton;
    ...
    private FComboBox<BarGrid.ExcessBarWidth>       htmlExcessBarWidthComboBox;
