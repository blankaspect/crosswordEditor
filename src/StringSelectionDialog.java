...
////////////////////////////////////////////////////////////////////////
                                   ...
                                   List<String> candidates )
    {
        ...
        GuiUtilities.setPaddedLineBorder( fontNamePanel );

        int gridY = 0;

        // Label: element
        JLabel elementLabel = new FLabel( StringUtilities.firstCharToUpperCase( elementName ) + ":" );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static StringList showDialog( Component    parent,
                                         ...
                                         List<String> candidates )
    {
        return new StringSelectionDialog( GuiUtilities.getWindow( parent ), titleStr, elementName, strings,
                                          candidates ).getStrings( );
    }
