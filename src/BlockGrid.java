...
////////////////////////////////////////////////////////////////////////
    ...
    public static final     double  DEFAULT_BLOCK_IMAGE_LINE_WIDTH  = 1.0;
    ...
    private static final    String  BACKGROUND_COLOUR_PROPERTY  = "background-color";

    private static final    String  IMAGE_SELECTOR  =
            HtmlConstants.ElementName.DIV + HtmlConstants.CssSelector.CLASS + HtmlConstants.Class.BLOCK +
            HtmlConstants.CssSelector.CHILD + HtmlConstants.ElementName.IMG;
    ...
    (
        ...
        (
            HtmlConstants.ElementName.DIV + HtmlConstants.CssSelector.CLASS + HtmlConstants.Class.BLOCK,
            new CssRuleSet.Decl( BACKGROUND_COLOUR_PROPERTY, "%1" )
        ),
        new CssRuleSet
        (
            IMAGE_SELECTOR,
            new CssRuleSet.Decl( "visibility", "hidden" )
        )
    );
    ...
    ////////////////////////////////////////////////////////////////////
            ...
            throws IOException
        {
            ...
            if ( blocked )
            {
                ...
                attributes.add( new Attribute( HtmlConstants.AttrName.SRC,
                                               getBlockImagePathname( cellSize ) ) );
            ...
            for ( int column = 0; column < numColumns; ++column )
            {
                ...
                for ( int iy = imageY - (sampleSize - 1); iy < endY; ++iy )
                {
                    ...
                    for ( int ix = imageX - (sampleSize - 1); ix < endX; ++ix )
                    {
                        ...
                        {
                            brightnessSum += ColourUtilities.getBrightness( image.getRGB( ix, iy ) );
                            ++numSamples;
                        }
                    }
                }
                if ( (numSamples == 0) || (brightnessSum / (float)numSamples < brightnessThreshold) )
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return StringUtilities.substitute( BLOCK_IMAGE_PATHNAME, Integer.toString( size ) );
    }
...
////////////////////////////////////////////////////////////////////////
                                              ...
                                              double fieldNumberFontSizeFactor )
    {
        ...
        ruleSets.add( Cell.getStyleRuleSet( cellSize, gridColour, fieldNumberFontSizeFactor ) );
    ...
    public List<CssMediaRule> getStyleMediaRules( )
    {
        ...
        if ( config.isBlockImagePrintOnly( ) )
        {
            ...
            for ( CssRuleSet ruleSet : BLOCK_RULE_SETS )
            {
                ...
                if ( ruleSet.hasProperty( BACKGROUND_COLOUR_PROPERTY ) )
                {
                    String colourStr = ColourUtilities.colourToHexString( config.getHtmlGridColour( ) );
                    CssRuleSet.Decl decl = ruleSet.findDeclaration( BACKGROUND_COLOUR_PROPERTY );
