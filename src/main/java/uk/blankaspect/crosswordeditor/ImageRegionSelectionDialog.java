...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		{
			return ((selection == null) ? null : ImageUtils.getSubimage(image, selection));
		}
...
////////////////////////////////////////////////////////////////////////
	...
	public static BufferedImage showDialog(Component     parent,
										   ...
										   Rectangle     selection)
	{
		return new ImageRegionSelectionDialog(GuiUtils.getWindow(parent), titleStr, viewportWidth,
