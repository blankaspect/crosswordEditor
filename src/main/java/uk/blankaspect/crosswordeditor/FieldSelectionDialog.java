	...
	////////////////////////////////////////////////////////////////////
		...
		private FieldSelectionPanel(Grid.Field.Id selectedId)
		{
			...
			for (Direction direction : fieldMap.keySet())
			{
				...
				{
					int numDigits = NumberUtils.getNumDecDigitsInt(field.id.number);
			...
			for (Direction direction : fieldMap.keySet())
			{
				...
				int rows = NumberUtils.roundUpQuotientInt(numIds, COLUMNS_PER_ROW);
			...
			numColumnsNone = NumberUtils.roundUpQuotientInt(noneWidth, columnWidth);
