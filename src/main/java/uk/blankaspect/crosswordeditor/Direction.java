...
////////////////////////////////////////////////////////////////////////
	...
	private static final	Map<Direction, List<String>>	KEYWORD_LISTS	= Map.of
	(
		Direction.ACROSS, List.of("Across", " Across", " across", "Ac", " ac", "A", " a"),
		Direction.DOWN,   List.of("Down",   " Down",   " down",   "Dn", " dn", "D", " d")
	);
...
////////////////////////////////////////////////////////////////////////
	...
	{
		return Arrays.stream(values()).filter(value -> value.suffix.equals(suffix)).findFirst().orElse(null);
	}
