...
////////////////////////////////////////////////////////////////////////
	...
	protected abstract int[] getFieldNumberOffsets(
		int	row,
		int	column);

	//------------------------------------------------------------------

	protected abstract void drawSeparators(
		Graphics	gr);

	//------------------------------------------------------------------

	protected abstract void drawSeparator(
		Graphics	gr,
		int			row,
		int			column);
	...
	protected abstract boolean toggleSeparator(
		int	x,
		int	y);
...
////////////////////////////////////////////////////////////////////////
		...
		Graphics	gr)
	{
				...
				&& ((rect.x + rect.width - 1) / cellSize == column) && ((rect.y + rect.height - 1) / cellSize == row))
		{
			...
			int y = row * cellSize;
			if (!editable || document.isShowFieldNumbers())
			{
...
//				gr2d.drawRect(x, y, cellSize - 2, cellSize - 2);
		...
		else
		{
			...
			if (isEditing())
			{
				...
				{
					gr2d.fillRect(indices.column * cellSize + 1, indices.row * cellSize + 1, cellSize - 1,
								  cellSize - 1);
				}
...
////////////////////////////////////////////////////////////////////////
	...
	public void setHighlightFullyIntersecting(
		boolean	highlight)
	{
	...
	public Clue.FieldList setSelection(
		Direction	direction)
	{
	...
	public Clue.FieldList incrementCaretPosition(
		int	increment)
	{
	...
	public Clue.FieldList incrementCaretColumn(
		int	increment)
	{
		Clue.FieldList fields = null;
	...
	public Clue.FieldList incrementCaretRow(
		int	increment)
	{
		Clue.FieldList fields = null;
		if ((caretPosition == null) && selectedFields.enabled)
	...
	private Clue.FieldList getClueFields(
		int			row,
		int			column,
		Direction	direction)
	{
	...
	private Clue.FieldList incrementCaretColumn(
		Grid.IndexPair	position,
		int				increment)
	{
		Clue.FieldList fields = null;
	...
	private Clue.FieldList incrementCaretRow(
		Grid.IndexPair	position,
		int				increment)
	{
		Clue.FieldList fields = null;
	...
	private void incrementEditColumn(
		int	increment)
	{
		if (!editable)
			return;
...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		@Override
		protected int[] getFieldNumberOffsets(
			int	row,
			int	column)
		{
			return new int[] { 1, 0 };
		...
		@Override
		protected boolean toggleSeparator(
			int	x,
			int	y)
		{
	...
	////////////////////////////////////////////////////////////////////
		...
		private static BarGrid.Edge getEdgeForSelector(
			int	selector)
		{
	...
	////////////////////////////////////////////////////////////////////
		...
		private boolean cellHasLeftBar(
			int	row,
			int	column)
		{
	...
	////////////////////////////////////////////////////////////////////
		...
		private void show()
		{
			CrosswordView view = CrosswordEditorApp.INSTANCE.getView();
			if (view != null)
