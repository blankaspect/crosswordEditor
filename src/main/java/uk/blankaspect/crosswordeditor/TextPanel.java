...
////////////////////////////////////////////////////////////////////////
					 ...
					 boolean noLfs)
	{
		...
		GuiUtils.setPaddedLineBorder(styleButtonOuterPanel, 1);
...
////////////////////////////////////////////////////////////////////////
	...
	public void propertyChange(PropertyChangeEvent event)
	{
		if (event.getPropertyName().equals(ANCESTOR_PROPERTY_NAME) && (event.getNewValue() == null))
			InputMapUtils.restoreInputMap(inputMapKey);
	}
...
////////////////////////////////////////////////////////////////////////
	...
	private void showContextMenu(MouseEvent event)
	{
		if ((event == null) || event.isPopupTrigger())
		{
			...
			COMMANDS.get(Command.PASTE).setEnabled(Utils.clipboardHasText());
