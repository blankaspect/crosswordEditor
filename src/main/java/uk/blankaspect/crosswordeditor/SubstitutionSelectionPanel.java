...
////////////////////////////////////////////////////////////////////////
	...
	public SubstitutionSelectionPanel(int numRows)
	{
		...
		substitutionListScrollPane = new JScrollPane(substitutionList, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
		...
		putClientProperty(PropertyKeys.PREFERRED_FOCUS_OWNER, addButton);
	}
