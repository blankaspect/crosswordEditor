...
////////////////////////////////////////////////////////////////////////
                               ...
                               List<Substitution>      clueSubstitutions )
    {
        ...
        GuiUtilities.setPaddedLineBorder( infoPanel );
        ...
        String str = TextUtilities.getWidestString( getFontMetrics( AppFont.MAIN.getFont( ) ), strs ).str;
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Result showDialog( Component               parent,
                                     ...
                                     List<Substitution>      clueSubstitutions )
    {
        return new ImportCluesDialog( GuiUtilities.getWindow( parent ), directions, clueReferenceKeyword,
