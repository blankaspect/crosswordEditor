...
import uk.org.blankaspect.util.ParameterSet;
            ...
            throws AppException
        {
            ...
            catch ( PatternSyntaxException e )
            {
                InputException exception = new InputException( CaptureParams.ErrorId.MALFORMED_PATTERN,
                                                               input );
                exception.setSubstitutionStrings( RegexUtilities.getExceptionMessage( e ) );
                throw exception;
            }
        }
...
////////////////////////////////////////////////////////////////////////
    ...
    @Override
    protected void putProperties( Property.Target propertyTarget )
    {
        for ( Property property : getProperties( ) )
