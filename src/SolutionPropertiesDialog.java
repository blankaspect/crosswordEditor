...
import uk.org.blankaspect.textfield.PasswordField;
...
////////////////////////////////////////////////////////////////////////
                                      ...
                                      CrosswordDocument.SolutionProperties properties )
    {
        ...
        hashValue = properties.hashValue;
        ...
        saveSolutionWithDocumentCheckBox.setSelected( properties.location == null );
        ...
        if ( properties.location != null )
            locationField.setText( properties.location.toString( ) );
        ...
        field.setText( properties.passphrase );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static CrosswordDocument.SolutionProperties showDialog(
                                                        Component                            parent,
                                                        CrosswordDocument.SolutionProperties properties )
    {
        return new SolutionPropertiesDialog( GuiUtilities.getWindow( parent ), properties ).getResult( );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private CrosswordDocument.SolutionProperties getResult( )
    {
        ...
        if ( accepted )
        {
            try
            {
                result = new CrosswordDocument.SolutionProperties( getUrl( ),
                                                                   passphrasePanel.getPassphrase( ),
                                                                   hashValue );
            }
    ...
    {
        PasswordField field = passphrasePanel.getField( );
        field.setBackground( field.isEmpty( ) ? PASSPHRASE_FIELD_EMPTY_BACKGROUND
                                              : passphraseFieldBackgroundColour );
    }
    ...
    private void showContextMenu( MouseEvent event )
    {
        if ( passphrasePanel.isEnabled( ) )
        {
            if ( event == null )
                ...
                passphrasePanel.getContextMenu( ).show( event.getComponent( ), event.getX( ),
                                                        event.getY( ) );
        }
    }
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( locationField );
